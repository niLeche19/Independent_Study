...
##########
		...
		if len(tmplst) > 1:
			...
			wheree = 1
		try:
			if wheree < 1 or (wheree > len(tmplst) and len(tmplst) > 1):
				print(" Please input a number 1 - {}\n".format(len(tmplst)))
				screentwo(key)
			else:
