...
#echo "05010906a101050719e029e71500250175019508810275089501810175019503050819012903910275019505910175089506150026ff00050719002aff008100c0" | sudo tee xxd -r -ps > /sys/kernel/config/usb_gadget/macroboy/functions/hid.usb0/report_desc
